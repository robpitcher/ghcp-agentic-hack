...
> - This capstone guide has no fixed slide-generation count because it is a hands-on hack guide and does not use `Slide topic` markers; add explicit markers before generating a PPTX deck from it.
