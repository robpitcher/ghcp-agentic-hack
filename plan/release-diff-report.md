...
1. **New source-of-truth workshop guides** — 3 new `-workshop.md` files serve as authoritative content designed for AI slide generator slide generation
...
- Designed to be fed into AI slide generator for visual slide deck generation
