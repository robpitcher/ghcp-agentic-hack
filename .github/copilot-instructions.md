...
- `<name>-workshop.md` — source of truth content (AI slide generator input)
...
- `<name>-QUIZ.md` — optional interactive quiz (authored separately, not generated by AI slide generator)
...
Quiz files are authored separately (not generated by AI slide generator) and rendered as interactive pages on the Astro site.
...
- Split larger workshop sources into part packets at natural section boundaries; name resulting PPTX files `source/pptx/<folder>-part-1.pptx`, `source/pptx/<folder>-part-2.pptx`, and so on.
